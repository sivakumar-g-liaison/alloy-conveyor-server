...
public class ProcessorLegacyDTOTest {
	 ...
	 */
	@Test (expectedExceptions = MailBoxConfigurationServicesException.class, expectedExceptionsMessageRegExp = "Either the Password or the SSh Keypair ID is Empty" )
	 ...
	 */
	@Test
	public void testcheckForSSHKeyPair() {
		...
		Assert.assertTrue(processorDTO.checkForSSHKeyPair());
	}
	 ...
	 */
	@Test
	public void testcheckForSSHKeyPairInvalid() {
		...
		ProcessorLegacyDTO processorDTO = new ProcessorLegacyDTO();
		processorDTO.setCredentials(credentials);
		Assert.assertFalse(processorDTO.checkForSSHKeyPair());
