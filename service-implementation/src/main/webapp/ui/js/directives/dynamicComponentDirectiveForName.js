        ...
        return {
            ...
            template: '<div ng-switch on="allowAdd">' +
                ...
                <div ng-form="form">\n\
                    ...
                    <textarea class="form-control alignDynamicTextarea" ng-show="addNew.value" ng-model="addedProperty.value" placeholder="required" style="width:48%;height:45px;"></textarea></div>\n\
                  </div>',
            link: function (scope) {
