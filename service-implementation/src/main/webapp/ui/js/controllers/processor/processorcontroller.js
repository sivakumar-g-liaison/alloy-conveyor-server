    ...
    'ProcessorCntrlr', ['$rootScope', '$modal', '$scope', '$timeout',
        ...
        $scope.validatePageNumberValue = function(newVal, oldVal) {
            ...
            $scope.backToMailbox = function () {			
				...
				$location.$$search = {};
				$location.path('/mailbox/addMailBox').search('mailBoxId', redirectToId).search('disableFilters', isDisableFilterValue).search('isProcessorSearch', isProcessorSearchFlag);
            };
