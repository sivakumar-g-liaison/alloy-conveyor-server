CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.CREDENTIAL
(
	...
	TYPE VARCHAR2(32) CONSTRAINT NN03_CREDENTIAL NOT NULL
		CONSTRAINT CK01_CREDENTIAL CHECK (TYPE IN ('TRUSTSTORE_CERT', 'SH_KEYPAIR', 'LOGIN_CREDENTIAL')),
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.CREDENTIAL ADD 
...
CREATE INDEX FK01_CREDENTIAL ON NDEV_GATEWAY_DTDM_OWNR.CREDENTIAL
(
	PROCESSOR_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.FOLDER
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.FOLDER ADD 
...
CREATE INDEX FK01_FOLDER ON NDEV_GATEWAY_DTDM_OWNR.FOLDER
(
	PROCESSOR_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX ADD 
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_PROPERTY
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_PROPERTY ADD 
...
CREATE INDEX FK01_MAILBOX_PROPERTY ON NDEV_GATEWAY_DTDM_OWNR.MAILBOX_PROPERTY
(
	MAILBOX_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE ADD 
...
CREATE INDEX FK01_MAILBOX_SVC_INSTANCE ON NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE
(
...
CREATE INDEX FK02_MAILBOX_SVC_INSTANCE ON NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE
(
	MAILBOX_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.PROCESSOR
(
	...
	TYPE VARCHAR2(128) CONSTRAINT NN06_PROCESSOR NOT NULL
		CONSTRAINT CK01_PROCESSOR CHECK (TYPE IN ('REMOTEDOWNLOADER', 'REMOTEUPLOADER', 'SWEEPER')),
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.PROCESSOR ADD 
...
CREATE INDEX FK01_PROCESSOR ON NDEV_GATEWAY_DTDM_OWNR.PROCESSOR
(
	MAILBOX_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE INDEX FK02_PROCESSOR ON NDEV_GATEWAY_DTDM_OWNR.PROCESSOR
(
	SERVICE_INSTANCE_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.PROCESSOR_PROPERTY
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.PROCESSOR_PROPERTY ADD 
...
CREATE INDEX FK01_PROCESSOR_PROPERTY ON NDEV_GATEWAY_DTDM_OWNR.PROCESSOR_PROPERTY
(
	PROCESSOR_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.SCHED_PROCESSOR
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.SCHED_PROCESSOR ADD 
...
CREATE INDEX FK01_SCHED_PROCESSOR ON NDEV_GATEWAY_DTDM_OWNR.SCHED_PROCESSOR
(
	SCHED_PROFILE_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE INDEX FK02_SCHED_PROCESSOR ON NDEV_GATEWAY_DTDM_OWNR.SCHED_PROCESSOR
(
	PROCESSOR_GUID
)
	TABLESPACE NDEV_GATEWAY_DTDM_CONF
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.SCHED_PROFILE
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.SCHED_PROFILE ADD 
...
CREATE TABLE NDEV_GATEWAY_DTDM_OWNR.SERVICE_INSTANCE
(
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.SERVICE_INSTANCE ADD 
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.CREDENTIAL ADD 
	CONSTRAINT FK01_CREDENTIAL FOREIGN KEY (PROCESSOR_GUID)
		REFERENCES NDEV_GATEWAY_DTDM_OWNR.PROCESSOR (PGUID) ON DELETE CASCADE ENABLE
;
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_PROPERTY ADD 
	CONSTRAINT FK01_MAILBOX_PROPERTY FOREIGN KEY (MAILBOX_GUID)
		REFERENCES NDEV_GATEWAY_DTDM_OWNR.MAILBOX (PGUID) ON DELETE CASCADE ENABLE
;

ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE ADD 
	CONSTRAINT FK01_MAILBOX_SVC_INSTANCE FOREIGN KEY (SERVICE_INSTANCE_GUID)
		REFERENCES NDEV_GATEWAY_DTDM_OWNR.SERVICE_INSTANCE (PGUID)
;

ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.MAILBOX_SVC_INSTANCE ADD 
	CONSTRAINT FK02_MAILBOX_SVC_INSTANCE FOREIGN KEY (MAILBOX_GUID)
		REFERENCES NDEV_GATEWAY_DTDM_OWNR.MAILBOX (PGUID)
;
...
ALTER TABLE NDEV_GATEWAY_DTDM_OWNR.SCHED_PROCESSOR ADD 
	CONSTRAINT FK01_SCHED_PROCESSOR FOREIGN KEY (SCHED_PROFILE_GUID)
		REFERENCES NDEV_GATEWAY_DTDM_OWNR.SCHED_PROFILE (PGUID) ON DELETE CASCADE ENABLE
;
