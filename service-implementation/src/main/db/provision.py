...
def main( argv ):
	...
	if len(userprefix) == 0:
		dbuserprefix = projectprefix + '_' + moniker
	else:
	...
	workingfolder = 'log/work/provision/' + dbuserprefix 
	logfile = 'log/provision.' + dbuserprefix + '.log.txt'
...
def printUsage():
	...
	print '                       database usernames are built from. (must be "DTDM" or "RTDM")'
