...
ADD CONSTRAINT CK01_PROCESSOR CHECK (TYPE IN ('REMOTEDOWNLOADER', 'REMOTEUPLOADER', 'SWEEPER', 'HTTPASYNCPROCESSOR', 'HTTPSYNCPROCESSOR', 'FILEWRITER', 'DROPBOXPROCESSOR', 'CONDITIONALSWEEPER', 'LITEHTTPSYNCPROCESSOR'));
