...
public interface MailBoxConstants {
    ...
    String LITEHTTPSYNCPROCESSOR = "LITEHTTPSYNCPROCESSOR";
    ...
    int RETRY_INTERVAL_MIN_VALUE = 0;
    ...
    String TOPIC_SWEEPER_EVENT_DEFAULT_TOPIC_SUFFIX = "com.liaison.queueservice.topic.sweeper.event.topicSuffix.default";
    String TOPIC_SWEEPER_EVENT_ADDITIONAL_TOPIC_SUFFIXES = "com.liaison.queueservice.topic.sweeper.event.topicSuffix.additional";
