...
public class MailBoxConfigurationService {
	 ...
	 * @throws JsonParseException
	 */
	public SearchMailBoxMinResponseDTO searchMailBoxMinResponse(GenericSearchFilterDTO searchFilter, String aclManifestJson)
		...
		List<MailBox> retrievedMailBoxes = null;
		Map<String, Integer> pageOffsetDetails = null;
		SearchMailBoxMinResponseDTO serviceResponse = new SearchMailBoxMinResponseDTO();
