...
public class EmailNotifier {
	...
	private static final String NOTE = "This message is automatically generated by the system.";
		...
		try {
			...
			if (!emailList.isEmpty()) {
				MailSend.Send(StringUtils.join(emailInfo.getToEmailAddrList(), ','),
						PROPS.getString(MAIL_FROM),
						emailInfo.getSubject(),
						emailContentBuilder.toString(),
						PROPS.getString(MAIL_HOST),
						CONTENT_TYPE);
			}
	 ...
	 * @param isSuccess boolean to set the status in the body
     */
	 ...
	 * @param isStagingSuccess boolean to set the status in the body
