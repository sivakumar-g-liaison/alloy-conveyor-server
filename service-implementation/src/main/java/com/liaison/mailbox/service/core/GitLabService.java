...
public class GitLabService {
	 ...
	 */
	public String createNewFile(String filePath, String branchName, String content, String commitMessage) throws IOException, JAXBException, javax.xml.bind.JAXBException {
	 ...
	 * @throws javax.xml.bind.JAXBException
	 */
	public String updateFile(String filePath, String branchName, String content, String commitMessage) throws IOException, JAXBException, javax.xml.bind.JAXBException {
		String commitMessageWithAuditInfo = constructCommitMessage(commitMessage);
		Object obj = api.dispatch()
				.method("PUT")
				.with("file_path", parseUri(filePath))
	 ...
	 * @throws IOException
	 */
	public String getFileContent(String sha, String filePath) throws IOException {
			return api.retrieve().to(String.format("/projects/%s/repository/commits/master/blob?filepath=%s",
					projectId, parseUri(filePath)));
	}
	...
	public List<GitlabCommit> getCommitHistory() throws IOException, JAXBException {
		LinkedHashMap[] mapArr = api.retrieve().to(String.format("/projects/%s/repository/commits", projectId), LinkedHashMap[].class);
