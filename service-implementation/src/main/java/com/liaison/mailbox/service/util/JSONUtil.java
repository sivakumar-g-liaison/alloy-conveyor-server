...
public class JSONUtil {
	 ...
	 * @throws IOException
	 */
	public static <T> T unmarshalFromKeyManagerJSON(String serializedJson, Class<T> clazz) throws JAXBException, JsonParseException, JsonMappingException, IOException {
