    ...
    public Response deleteProcessor(
        ...
        AbstractResourceDelegate<Object> worker = new AbstractResourceDelegate<Object>() {
            ...
            public Object call() {
                ...
                return service.deactivateProcessor(mailboxguid, guid, userId);
            }
        };
    ...
    public Response getProcessor(
        ...
        AbstractResourceDelegate<Object> worker = new AbstractResourceDelegate<Object>() {
            ...
            public Object call()
                ...
                ProcessorConfigurationService service = new ProcessorConfigurationService();
                return service.getProcessor(mailboxguid, guid);
        ...
        AbstractResourceDelegate<Object> worker = new AbstractResourceDelegate<Object>() {
            ...
            public Object call()
                ...
                try {
                    ...
                    ProcessorConfigurationService service = new ProcessorConfigurationService();
                    final String userId = getUserIdFromHeader(request);
                    return service.reviseProcessor(serviceRequest, mailboxguid, guid, userId);
