...
public class SFTPRemoteDownloader extends AbstractRemoteProcessor implements MailBoxProcessor {
	 ...
	 * 
	 */
	protected static void executeRequest() throws MailBoxServicesException, LiaisonException, IOException, FS2Exception,
	...
	public static void main(String [] args){
		...
		try {
			executeRequest();
		} catch (MailBoxServicesException | LiaisonException | IOException
				| FS2Exception | URISyntaxException | JAXBException e) {
			e.printStackTrace();
		}
	}
}
