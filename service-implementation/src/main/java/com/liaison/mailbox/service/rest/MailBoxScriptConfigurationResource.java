...
public class MailBoxScriptConfigurationResource extends AuditedResource {	
	 ...
	 */
	 @POST
	 @ApiOperation(value = "Create a new script file to GitLab",
     notes = "This function creates a new script file in GitLab",
     position = 1,
     response=com.liaison.mailbox.service.dto.configuration.response.ScriptServiceResponseDTO.class)
     @Consumes(MediaType.APPLICATION_JSON)
 	 @Produces(MediaType.APPLICATION_JSON)
	 @ApiImplicitParams({ @ApiImplicitParam(name = "request", value = "create a new script", required = true,
	 ...
	 */
	 @PUT
	 @ApiOperation(value = "update a new script file to GitLab",
     notes = "This function update a new script file in GitLab",
     position = 2,
     response=com.liaison.mailbox.service.dto.configuration.response.ScriptServiceResponseDTO.class)
     @Consumes(MediaType.APPLICATION_JSON)
 	 @Produces(MediaType.APPLICATION_JSON)
	 @ApiImplicitParams({ @ApiImplicitParam(name = "request", value = "update a new script", required = true,
	 dataType = "com.liaison.mailbox.service.dto.configuration.response.ScriptServiceResponseDTO", paramType = "body") })
	 @ApiResponses({
	 @ApiResponse( code = 500, message = "Unexpected Service failure." )
	 })
