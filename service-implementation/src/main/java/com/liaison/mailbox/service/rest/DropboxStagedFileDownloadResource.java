		...
		AbstractResourceDelegate<Object> worker = new AbstractResourceDelegate<Object>() {
			...
			public Object call()
				...
				try {
                    ...
                    // Log running status
					glassMessage.logProcessingStatus(StatusType.RUNNING, MailBoxConstants.DROPBOX_SERVICE_NAME + ": User " + loginId + " file download", null, MailBoxConstants.DROPBOX_PROCESSOR);
					...
					glassMessage.logProcessingStatus(StatusType.SUCCESS, MailBoxConstants.DROPBOX_SERVICE_NAME + ": User " + loginId + " file download", null, MailBoxConstants.DROPBOX_PROCESSOR);
					...
					// Log Failed status
					glassMessage.logProcessingStatus(StatusType.ERROR, MailBoxConstants.DROPBOX_SERVICE_NAME + ": User " + loginId + " file download", null, MailBoxConstants.DROPBOX_PROCESSOR);
