...
@NamedQueries({
	@NamedQuery(name = GatewayTypeConfigurationDAO.GET_BY_NAME, query = "select gateType from GatewayType gateType where gateType.name = :"
			+ GatewayTypeConfigurationDAO.NAME),
		@NamedQuery(name = GatewayTypeConfigurationDAO.GET_ALL, query = "select gateType from GatewayType gateType where gateType.name") })
