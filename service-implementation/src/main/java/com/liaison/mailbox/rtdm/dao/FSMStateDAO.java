...
public interface FSMStateDAO extends GenericDAO<FSMState>, FSMDao<ProcessorStateDTO, ExecutionEvents> {
	...
	public static final String FIND_ALL_EXECUTING_PROC = "findAllExecutingProcessors";
	public static final String FIND_EXECUTING_PROC_BY_VALUE = "findProcessorsByValue";
	public static final String FIND_EXECUTING_PROC_BY_DATE = "findProcessorsByDate";
	public static final String FIND_EXECUTING_PROC_BY_VALUE_AND_DATE = "findProcessorsByValueAndDate";
	public static final String FIND_ALL_EXECUTING_PROC_BY_PROCESSORID = "findAllExecutingProcessorsByProcessorId";
