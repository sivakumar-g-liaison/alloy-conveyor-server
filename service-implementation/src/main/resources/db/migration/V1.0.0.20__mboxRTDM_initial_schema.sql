...
CREATE TABLE GATEWAY_OWNR.PROCESSOR_EXECUTION_STATE
(
	PGUID CHAR(32) NOT NULL,
	PROCESSOR_ID CHAR(32) NOT NULL,
...
ALTER TABLE GATEWAY_OWNR.PROCESSOR_EXECUTION_STATE ADD 
	CONSTRAINT PK_PROCESSOR_EXECUTION_STATE PRIMARY KEY (PGUID)
		USING INDEX
			TABLESPACE GATEWAY_CONF
			STORAGE
			(
