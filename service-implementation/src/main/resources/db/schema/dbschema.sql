...
--------------------------------------------------------
  ...
  CREATE TABLE "PROCESSORS" ("PGUID" CHAR(32), "MAILBOX_SCHED_PROFILES_GUID" CHAR(32), "PROCSR_DESC" VARCHAR2(512), "PROCSR_TYPE" VARCHAR2(128), "PROCSR_PROPERTIES" VARCHAR2(2048), "PROCSR_STATUS" VARCHAR2(128), "JAVA_SCRIPT_URI" VARCHAR2(512), "PROCSR_EXECUTION_ORDER" NUMBER(*,0), "PROCSR_NAME" VARCHAR2(512)) ;
