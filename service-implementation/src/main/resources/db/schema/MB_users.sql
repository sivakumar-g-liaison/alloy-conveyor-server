...
BEGIN
  ...
  IF NOT UserExists('GATEWAY_APPL') THEN
    v_stmt := 'CREATE USER GATEWAY_APPL IDENTIFIED BY FOO DEFAULT TABLESPACE JUNK TEMPORARY TABLESPACE GATEWAY_TEMP_01';
    EXECUTE IMMEDIATE v_stmt;
  END IF;
  ...
  IF NOT UserExists('GATEWAY_OWNR') THEN
    v_stmt := 'CREATE USER GATEWAY_OWNR IDENTIFIED BY FOO DEFAULT TABLESPACE JUNK TEMPORARY TABLESPACE GATEWAY_TEMP_01';
    EXECUTE IMMEDIATE v_stmt;
  END IF;
