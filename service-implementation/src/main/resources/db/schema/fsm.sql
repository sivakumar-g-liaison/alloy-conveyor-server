...
(
	PGUID CHAR(32) CONSTRAINT NN01_FSM_STATE_VALUE NOT NULL,
	FSM_STATE_GUID CHAR(32) CONSTRAINT NN02_FSM_STATE_VALUE NOT NULL,
	VALUE VARCHAR2(2048) CONSTRAINT NN03_FSM_STATE_VALUE NOT NULL,
	CREATED_DATE TIMESTAMP CONSTRAINT NN04_FSM_STATE_VALUE NOT NULL
)
	TABLESPACE JUNK
	STORAGE
	(
...
(
	PGUID CHAR(32) CONSTRAINT NN01_FSM_STATE NOT NULL,
	NAME VARCHAR2(1024) CONSTRAINT NN02_FSM_STATE NOT NULL
)
	TABLESPACE JUNK
	STORAGE
	(
...
(
	...
	CREATED_DATE TIMESTAMP CONSTRAINT NN03_FSM_TRANSITION_LIST NOT NULL
)
	TABLESPACE JUNK
	STORAGE
	(
...
(
	PGUID CHAR(32) CONSTRAINT NN01_FSM_EVENT NOT NULL,
	NAME VARCHAR2(1024) CONSTRAINT NN02_FSM_EVENT NOT NULL,
	DATA VARCHAR2(2048) CONSTRAINT NN03_FSM_EVENT NOT NULL,
	CREATED_DATE TIMESTAMP CONSTRAINT NN04_FSM_EVENT NOT NULL
)
	TABLESPACE JUNK
	STORAGE
	(
