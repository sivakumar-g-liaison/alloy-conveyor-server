...
export GLASS_SPECTRUM_IP=at4s-vpspectrum.liaison.prod
...
export GLASS_SPECTRUM_MESSAGE_TTL=7776000
...
export GLASS_METRIC_IP=at4s-vpspectrum.liaison.prod
...
export GLASS_METRIC_TTL=7776000
...
export LOGSTASHMACHINE=at4s-vplstash.liaison.prod
